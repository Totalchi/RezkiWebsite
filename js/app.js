...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const LANGS = {
    en: {
      ...
      h1_line1: 'Building work',
      h1_line2_a: 'handled with',
      h1_em: 'care',
      h1_line2_b: '',
      hero_sub: 'Solar, batteries, EV chargers, windows, roofing and exterior painting for homes and properties around Gothenburg. Clear scope, tidy sites and written guarantees from the same accountable team.',
    ...
    sv: {
      ...
      h1_line1: 'Byggarbete',
      h1_line2_a: 'utfört med',
      h1_em: 'omsorg',
      h1_line2_b: '',
      hero_sub: 'Solceller, batterier, laddboxar, fönster, tak och fasadmålning för hem och fastigheter runt Göteborg. Tydlig omfattning, ordning på arbetsplatsen och skriftliga garantier från samma ansvariga team.',
