...
const TRANSLATIONS = {
  en: {
    nav:   ['Services', 'About', 'Projects', 'Quality', 'Book Now'],
    ...
    btn2:  'See What We Do',
    scroll: 'Scroll down',
    stats: ['Direct contact', 'Written quote', 'Work guarantee', 'Local coverage'],
    ...
    svcPage: {
      ...
      solar: {
        ...
        statNums: ['Site visit first', '1-2 days'],
        stats: ['Production calculation before ordering', 'Typical on-site install for a villa'],
      ...
      ev: {
        ...
        statNums: ['Load balanced', '1 day'],
        stats: ['Suitable for homes, BRFs and shared parking', 'Typical home installation'],
      ...
      roof: {
        ...
        statNums: ['Inspection first', '10 years'],
        stats: ['Moisture and structure check before quote', 'Workmanship guarantee on roof work'],
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: 'Yes. We can scope shared electrical infrastructure, prepare decision material for the board and coordinate with the property manager. If a project needs external specialists such as scaffolding or grid coordination, we stay as the single point of contact throughout.',
          },
          {
    ...
    stag2: 'Example Scopes',
    st2:   'Typical projects we help with',
    ss2:   'Examples of the kind of work we can scope, price and deliver for homes, associations and small businesses.',
    gl: [
      '&#9728;&#65039; Solar planning for detached homes',
      '&#128396;&#65039; Facade painting and exterior care',
      '&#127968; Roof replacement and repair',
      '&#9889; EV charging for homes and BRFs',
      '&#129695; Window replacement and sealing',
      '&#128267; Battery storage and energy upgrades',
    ],

    stag3: 'About RM Bygg & Montage',
    st3:   "We're not a big<br/>anonymous company",
    ss3a:  "RM Bygg & Montage AB is built around a simple belief: every customer deserves personal service, honest communication, and work you're proud to show off.",
    ...
    stag5: 'Why Work With Us',
    st5:   'Clear process \u2013<br/>solid guarantees',
    rn: ['Direct contact', 'Written scope', 'Aftercare'],
    revs: [
      'You deal directly with the team handling the work. Questions get answered quickly, clearly and without sales pressure.',
      'Before work starts, you get a written quote, a defined scope and straightforward communication about what is included.',
      'Our work is covered by clear workmanship guarantees, and if something needs fixing we come back and sort it out.',
    ],
    rt: ['No call centre, no middlemen', 'Clear expectations before start', 'Written guarantees after handover'],
    ...
    fc: {
      ...
      c2:    ['About Us', 'Our Process', 'Quality & Guarantees', 'Projects'],
  ...
  sv: {
    nav:   ['Tj\u00e4nster', 'Om oss', 'Projekt', 'Kvalitet', 'Boka Nu'],
    ...
    btn2:  'Vad Vi G\u00f6r',
    scroll: 'Scrolla ned',
    stats: ['Direkt kontakt', 'Skriftlig offert', 'Garanti pa arbete', 'Lokalt omrade'],
    ...
    svcPage: {
      ...
      solar: {
        ...
        statNums: ['Platsbesok forst', '1-2 dagar'],
        stats: ['Produktionskalkyl innan bestallning', 'Typisk monteringstid pa plats for villa'],
      ...
      ev: {
        ...
        statNums: ['Lastbalansering', '1 dag'],
        stats: ['Passar villor, BRF och delad parkering', 'Normal installation i villa'],
      ...
      roof: {
        ...
        statNums: ['Kontroll forst', '10 \u00e5r'],
        stats: ['Fukt- och konstruktionskontroll fore offert', 'Garanti pa takarbeten'],
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: 'Ja. Vi kan dimensionera delad elinfrastruktur, ta fram beslutsunderlag till styrelsen och samordna med fastighetsf\u00f6rvaltaren. Om projektet kr\u00e4ver externa specialister, som st\u00e4llning eller kontakt med n\u00e4tbolag, \u00e4r vi fortfarande din tydliga huvudkontakt genom hela arbetet.',
          },
          {
    ...
    stag2: 'Typiska Upplagg',
    st2:   'Projekt vi ofta hjalper till med',
    ss2:   'Exempel pa arbeten vi kan kalkylera, planera och utfora for privatpersoner, BRF:er och mindre foretag.',
    gl: [
      '&#9728;&#65039; Solplanering for villor',
      '&#128396;&#65039; Fasadmalning och utvandigt underhall',
      '&#127968; Takbyte och takrenovering',
      '&#9889; Laddning for villor och BRF',
      '&#129695; Fonsterbyte och tatning',
      '&#128267; Batterilager och energiuppgradering',
    ],

    stag3: 'Om RM Bygg & Montage',
    st3:   'Vi \u00e4r inte ett stort<br/>anonymt bolag',
    ss3a:  'RM Bygg & Montage AB bygger pa en enkel overtygelse: att varje kund fortjanar personlig service, arlig kommunikation och ett arbete man ar stolt over.',
    ...
    stag5: 'Varfor Valja Oss',
    st5:   'Tydlig process \u2013<br/>stabila garantier',
    rn: ['Direkt kontakt', 'Skriftligt omfang', 'Efterservice'],
    revs: [
      'Du har direktkontakt med teamet som skoter jobbet. Fragor besvaras snabbt, tydligt och utan saljtryck.',
      'Innan arbetet startar far du en skriftlig offert, ett tydligt omfang och rak kommunikation om vad som ingar.',
      'Vart arbete omfattas av tydliga garantier, och om nagot behovs justeras kommer vi tillbaka och losar det.',
    ],
    rt: ['Inget callcenter, inga mellanhander', 'Tydliga forvantningar innan start', 'Skriftliga garantier efter overlamning'],
    ...
    fc: {
      ...
      c2:    ['Om Oss', 'Var Process', 'Kvalitet & Garantier', 'Projekt'],
